...
public class teste {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("Ops! na verdade... " + nome + ", você envelheceu e agora tem: ");
       System.out.println("-Você tem " + x.envelhece()+ " anos;");
       System.out.println("-"+ x.engordar() + " Kg;");
       System.out.println("-"+ x.emagrecer() + " Kg");
       System.out.println("-E " + x.crescer() + " Cm.");
      ...
      System.out.print("Aumente o volume conforme sua preferência: ");
      int volume = entrada.nextInt();
       ...
       tv samsung = new tv(canal, volume);
      System.out.println(samsung.dVolume());
    }
